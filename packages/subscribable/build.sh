...
$BIN_PATH/luacheck main.lua pkg-api.lua storage-vanilla.lua storage-db.lua utils.lua
$BIN_PATH/amalg.lua -s main.lua -o ../build/main.lua pkg-api storage-vanilla storage-db utils
